...
urlpatterns = [
    ...
    path('api/tutor/<int:tutor_id>/ratings/', TutorRatingCreateAPIView.as_view(), name='tutor-rating-create'),
    #path('api/client/attendance/', ClientAttendanceListCreateAPIView.as_view(), name='client-attendance-list-create'),
